...
export const GET_ONE_TOURNAMENT_REQUEST = 'GET_ONE_TOURNAMENT_REQUEST';
export const GET_ONE_TOURNAMENT_SUCCESS = 'GET_ONE_TOURNAMENT_SUCCESS';
export const GET_ONE_TOURNAMENT_FAIL = 'GET_ONE_TOURNAMENT_FAIL';
